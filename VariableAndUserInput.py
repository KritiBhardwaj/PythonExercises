# program that takes two numbers from the user, and outputs their sum
num1A = input("Enter the first number: ")
num1B = input("Enter the second number: ")
sum = int(num1A) + int(num1B)
print(sum)

# program that takes two numbers from the user, and outputs the equation representing the
